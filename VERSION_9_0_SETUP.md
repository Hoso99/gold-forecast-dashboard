# Gold Version 9.2 — Calibrated Regime-Ensemble Challenger

Version 9.2 is separate from Version 8.2.5. It does not replace `app_v82.py` or `forecast_ledger_v825.sqlite` and contains no broker execution.
